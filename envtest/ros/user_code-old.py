...
def normalize_img_obs(drone_state):
    ...
    drone_state[:, 7] = _normalize(drone_state[:, 3], -3, 65)
...
# load_path = "/home/cam/Modelli-decenti/PPO_0583_with_mpc_ppo_depth_2/best_model/best_model.zip"  # depth 3 frame
load_path = "/home/cam/Modelli-decenti/PPO_0587_state_based_Xline/best_model/best_model.zip"  # OBS
