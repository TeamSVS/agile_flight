...
load_path = "/home/cam/Modelli-decenti/PPO_0583_with_mpc_ppo_depth_2/best_model/best_model.zip"  # OBS
...
def compute_command_vision_based(state, img):
    ...
    real_action = actual_mpc(float(depth), width, height, pos, vel, att, omega)
