...
def main():
    ...
    if args.load:
        ...
        model = PPO.load(load_path, env=train_env, device='cuda:0', custom_objects=None, print_system_info=True, force_reset=True)
    else:
        model = PPO(
            ...
            batch_size=40,  # num batch != num env!! to use train env, as eval env need to use 1 num env!
            n_steps=20,  # Ragne: 512-5000
